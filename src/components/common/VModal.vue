...
export default {
    ...
    components: {
        ...
        ModalCardDelete: defineAsyncComponent(() => import('@/components/Profile/Cards/ModalCardDelete.vue')),
        ModalCardRecovery: defineAsyncComponent(() => import('@/components/Profile/Cards/ModalCardRecovery.vue')),
